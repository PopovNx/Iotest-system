...
namespace Objects {
    ...
    export class ElectronsObjects extends DragableObject {
        static Types = {
            ...
            Hdd: {
                textures: [
                    'TestItems/Prefabs/Electrons/Hdd/1.png',
                    'TestItems/Prefabs/Electrons/Hdd/2.png',
                    'TestItems/Prefabs/Electrons/Hdd/3.png',
                ]
            },
            Ssd: {
                textures: [
                    'TestItems/Prefabs/Electrons/Ssd/1.png',
                    'TestItems/Prefabs/Electrons/Ssd/2.png',
                ]
            },
            Cpu: {
                textures: [
                    'TestItems/Prefabs/Electrons/Cpu/1.png',
                    'TestItems/Prefabs/Electrons/Cpu/2.png',
                    'TestItems/Prefabs/Electrons/Cpu/3.png',
                ]
            },
            Motherboard: {
                textures: [
                    'TestItems/Prefabs/Electrons/Motherboard/1.png',
                    'TestItems/Prefabs/Electrons/Motherboard/2.png',
                    'TestItems/Prefabs/Electrons/Motherboard/3.png',
                ]
            },
            Ram: {
                textures: [
                    'TestItems/Prefabs/Electrons/Ram/1.png',
                    'TestItems/Prefabs/Electrons/Ram/2.png',
                    'TestItems/Prefabs/Electrons/Ram/3.png',
                ]
            },
            SoundCard: {
                textures: [
                    'TestItems/Prefabs/Electrons/SoundCard/1.png',
                    'TestItems/Prefabs/Electrons/SoundCard/2.png',
                ]
            },
            PowerSupply: {
                textures: [
                    'TestItems/Prefabs/Electrons/PowerSupply/1.png',
                    'TestItems/Prefabs/Electrons/PowerSupply/2.png', 
                ]
            },
            Screen: {
                textures: [
                    'TestItems/Prefabs/Electrons/Screen/1.png',
                    'TestItems/Prefabs/Electrons/Screen/2.png',
                ]
            },
            Mouse: {
                textures: [
                    'TestItems/Prefabs/Electrons/Mouse/1.png',
                    'TestItems/Prefabs/Electrons/Mouse/2.png',
                    'TestItems/Prefabs/Electrons/Mouse/3.png',
                ]
            },
            Keyboard: {
                textures: [
                    'TestItems/Prefabs/Electrons/Keyboard/1.png',
                    'TestItems/Prefabs/Electrons/Keyboard/2.png',
                    'TestItems/Prefabs/Electrons/Keyboard/3.png',
                ]
            },
        }
...
namespace Services {
    ...
    export class VisualTest {
        constructor(smap, display) {
            this.Canvas = display;
            // @ts-ignore */}
            this.VDisplay = new PIXI.Application({ width: 750, height: 500, view: this.Canvas, transparent: true, antialias: true, })
