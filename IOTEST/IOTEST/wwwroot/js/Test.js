...
var Smap = new SavedMap(
    [
        ...
        new SavedMap.sObject("Dynamic", "Electrons", "Led", new SavedMap.sObject.PositionT(100, 100, 1, 20, 0,-1,1), 1, 1, 3),
    ...
    [
        ...
        new SavedMap.sTrigger(true, true, new SavedMap.sTrigger.PositionT(325 + 150, 400, 50), 2, 2, ["Electrons.Led:1"]),
    ],
    [
        //  new SavedMap.InteractorWorker([1], new SavedMap.InteractorWorker.OnSum("scene", ">=5"), new SavedMap.InteractorWorker.Interactor("Variator", [0, 1])),
       ...
       // new SavedMap.InteractorWorker([2], new SavedMap.InteractorWorker.OnСlick([2]), new SavedMap.InteractorWorker.Interactor("RotatorAdd", [0, 2])),
    ]
